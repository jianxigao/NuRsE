function FIgure2_beta
%% plot figure 2 in beta space
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% load data Net12
load('Results_node/3PLANT_POLLINATOR_Robertson_1929_A')
...
load('Results_link/3PLANT_POLLINATOR_Robertson_1929_link_A')
...
load('Results_weight/3PLANT_POLLINATOR_Robertson_1929_weight_A')
