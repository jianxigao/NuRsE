...
if pertubation_type == 1
    for i = 1:m
        ...
        plot(1-b(2:end,6),b(2:end,1),'-s','Color',net_color,'MarkerSize',simsize,'MarkerFaceColor',net_color,'MarkerEdgeColor',net_color,'LineWidth',0.01);hold on;
        plot(1-b(2:end,6),b(2:end,2),'-o','Color',net_color,'MarkerSize',simsize,'MarkerFaceColor',net_color,'MarkerEdgeColor',net_color,'LineWidth',0.01);
    end
...
elseif pertubation_type == 2
    for i = 1:m
        b(1:n,1:z) = net1_dat(i,1:n,1:z);
        plot(1-b(2:end,6),b(2:end,1),'-^','Color',net_color,'MarkerSize',simsize,'MarkerFaceColor',net_color,'MarkerEdgeColor',net_color,'LineWidth',0.01);hold on;
        plot(1-b(2:end,6),b(2:end,2),'-v','Color',net_color,'MarkerSize',simsize,'MarkerFaceColor',net_color,'MarkerEdgeColor',net_color,'LineWidth',0.01);
    end
    ...
    for i = 1:m
        b(1:n,1:z) = net1_dat(i,1:n,1:z);
        plot(1-b(2:end,6),b(2:end,1),'-<','Color',net_color,'MarkerSize',simsize,'MarkerFaceColor',net_color,'MarkerEdgeColor',net_color,'LineWidth',0.01);hold on;
        plot(1-b(2:end,6),b(2:end,2),'->','Color',net_color,'MarkerSize',simsize,'MarkerFaceColor',net_color,'MarkerEdgeColor',net_color,'LineWidth',0.01);
    end
