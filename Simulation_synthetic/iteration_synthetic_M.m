function output_one= iteration_synthetic_M(steps,output_one,A)
%   iteration_synthetic_M calculates the output for one step
%   of mutulistic dynamic on the network A
%
%   output_one= iteration_synthetic_M(steps,output_one,A)
%
%   Inputs:
...
%
%
%   See also iteration_synthetic_R. 

%   NuRsEv1.0
%   $Id: iteration_synthetic_M.m Created at 2015-10-22 13:45:29 $
