function A = generate_direct_midS_samew_SFk(lambda_k,meank,n,aij)
%   generate_direct_midS_samew_SFk generates directed Scale-Free 
%   networks without in- out-degree correlations
%
%   A = generate_direct_midS_samew_SFk(lambda_k,meank,n,aij)
%
%   Inputs:
...
%
%   See also generate_ER, generate_ERk_SFw, generate_samew_SFk, generate_SFw_SFk, ect. 

%   NuRsEv1.0
%   $Id: generate_direct_midS_samew_SFk.m Created at 2015-10-22 13:45:29 $
...
w_in = w_in(all);
all = randperm(n);
w_out = w_in(all); % without in- out- degree correlations
